...
<table><tr>
    ...
    <td>
      <a href="https://github.com/conda-forge/ecell4_base-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/ecell4_base-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
...
pixi add ecell4_base
# for installing globally
pixi global install ecell4_base
```
...
It is possible to list all of the versions of `ecell4_base` available on your platform:
...
```
pixi search ecell4_base --channel conda-forge
```
